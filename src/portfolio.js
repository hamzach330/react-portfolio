...
const skillsSection = {
    title: "What I do",
    subTitle: emoji(
        "🎓 Pursuing a Master's in AI | 📱 Working as a Mobile Developer | 🌐 Exploring Multiplatform Development"
    ),
    skills: [
        emoji(
            "⚡ Crafting seamless and snappy apps that keep users hooked and happy!"
        ),
        emoji(
            "⚡ Fluent in multiple programming languages, conjuring scalable and innovative solutions like magic."
        ),
        emoji(
            "⚡ Combining the best of mobile development with cutting-edge artificial intelligence for smarter, smoother user experiences."
        )
    ],
...
https://fontawesome.com/icons?d=gallery */
    ...
    softwareSkills: [
        {
            skillName: "Android",
            imageScr: require("./assets/images/androidLogo.png")
        },
        {
            skillName: "Compose",
            imageScr: require("./assets/images/composeLogo2.png")
        },
        {
            skillName: "Kotlin",
            imageScr: require("./assets/images/kotlinLogo.png")
        },
        {
            skillName: "Java",
            imageScr: require("./assets/images/javaLogo.png")
        },
        {
            skillName: "Flutter",
            imageScr: require("./assets/images/flutterLogo.png")
        },
        {
            skillName: "Python",
            imageScr: require("./assets/images/pythonLogo.png")
        },
        {
            skillName: "JavaScript",
            imageScr: require("./assets/images/jsLogo.png")
        },
        {
            skillName: "Swift",
            imageScr: require("./assets/images/swiftLogo.png")
        }
    ],
...
const educationInfo = {
    ...
    schools: [
        ...
        },
        {
            ...
            desc: "With a curriculum focuing towards Programming, Digital Logic Design, Operating Systems, Artificial Intelligence, and Network Security.",
            descBullets: [
...
const techStack = {
    ...
    experience: [
        {
            Stack: "Mobile Application Development", //Insert stack or technology you have experience in
            progressPercentage: "90%" //Insert relative proficiency in percentage
        },
        {
            Stack: "Artificial Intelligence and Machine Learning",
            progressPercentage: "80%"
        },
        {
            Stack: "Project Management and Optimization",
            progressPercentage: "65%"
        },
        {
            Stack: "Programming Languages and Frameworks",
    ...
    achievementsCards: [
...

        {
            ...
            footerLink: [
                {
                    name: "Certification",
                    url: "https://www.linkedin.com/learning/certificates/42973b5d57e827089d9bb711ed8b5916aea8a1012e25822c67219f52c120975b?trk=backfilled_certificate"
                }
            ]
        },
        {
            title: "RxJava: Design Patterns for Android Developer",
            // subtitle:
            //     "Completed Certifcation from SMIT for PWA Web App Development",
            image: require("./assets/images/LinkedInlogo2.png"),
            imageAlt: "linkedIn",
            footerLink: [
                {
                    name: "Certification",
                    url: "https://www.linkedin.com/learning/certificates/c25bad39b7baeafc2180f49409b3de6652510f797481ef2ef5f58853228c5c8e"
                }
            ]
        }
    ],
